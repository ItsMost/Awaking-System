...
const Container = styled(motion.div)`
  padding: 15px; font-family: 'Exo 2', sans-serif; color: #fff; padding-bottom: 100px; max-width: 600px; margin: 0 auto; direction: rtl;
...
const SeverityValue = styled.div<{ $color: string }>`
  font-size: 24px; font-weight: 900; color: ${(props) => props.$color}; text-shadow: 0 0 10px ${(props) => props.$color}; font-family: 'Exo 2'; width: 50px; text-align: center;
`;
